...
export const userRegistration = async (req: FastifyRequest, reply: FastifyReply, done: DoneFuncWithErrOrRes) => {
    ...
    try {
        ...
        await checkOtpRestrictions(data.email, done);
        await trackOtpRequests(data.email, done);
